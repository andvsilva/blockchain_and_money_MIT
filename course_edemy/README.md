...
## reference: https://www.trufflesuite.com/ganache
First, we need to install 'Ethereum development environment setup in Ubuntu'
...
```
[GANACHE OVERVIEW](https://www.trufflesuite.com/docs/ganache/overview)

![ganache](/course_edemy/picture/ganache.png)

![ganache](/course_edemy/picture/remix_ide.png)

![ganache](/course_edemy/picture/bytecode.png)

### Deploy Contract

![ganache](/course_edemy/picture/myetherwallet.png)
